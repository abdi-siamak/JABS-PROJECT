...
public abstract class AbstractDAGBasedConsensus<B extends Block<B>, T extends Tx<T>>
    ...
    public final LocalTxDAG localTxDAG;
    /**
    ...
    public AbstractDAGBasedConsensus(LocalBlockDAG<B> localBlockDAG) {
		...
		this.localTxDAG = null;
    }

    public AbstractDAGBasedConsensus(LocalTxDAG localTxDAG) {
        this.localBlockDAG = null;
		this.localTxDAG = localTxDAG;
    }
    ...
    public LocalTxDAG getLocalTxDAG() {
        return this.localTxDAG;
    }
