...
public final class TransactionFactory {
    ...
    public static AvalancheTx sampleAvalancheTransaction(Simulator simulator, RandomnessEngine randomnessEngine, AvalancheNode creator, List<AvalancheTx> parents, int height) {
    	return new AvalancheTx(height+1,(int) randomnessEngine.sampleDistributionWithBins(
                BITCOIN_TRANSACTION_SIZE_DISTRIBUTION, BITCOIN_TRANSACTION_SIZE_BINS), simulator.getSimulationTime(), creator, parents);
    }
