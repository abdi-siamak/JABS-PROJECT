...
public class Simulator {
    ...
    /**
     * Adjusts the simulation duration by adding the specified time increment.
     *
     * @param timeIncrement The amount of time to be added to the simulation duration in seconds.
     */
    public void incrementSimulationDuration(double timeIncrement) {
        simulationTime += timeIncrement;
    }
    /**
     * Adjusts the simulation duration by setting the specified time.
     *
     * @param time Time to be set to the simulation duration in seconds.
     */
    public void setSimulationDuration(double time) {
    	simulationTime = time;
    }
    /**
     * Retrieves the number of events currently stored in the event queue.
     *
