...
public abstract class Node {
    ...
    /**
     * Forces the node to broadcast a message to all nodes
     * @param message The message to be broadcasted to all nodes
     */
    ...
    /**
     * Forces the node to reply a message to the sender
     * @param message The message to be broadcasted
     */
    public void replyMessage(Message message, Node destination) {
        this.networkInterface.addToUpLinkQueue(
                new Packet(this, destination, message)
        );
    }
    /**
     * Forces the node to gossip a message to one of its neighbor randomly
     * @param message The message to be gossiped
     * @param destination The destination node
     */

    public void gossipMessage(Message message, Node destination) {
        this.networkInterface.addToUpLinkQueue(
                new Packet(this, destination, message));
    }
    /**
     * Sends update information for a newly joined node in the network.
     * @param message The message to be sent
     * @param destination The destination node
     */
    public void updateMessage(Message message, Node destination) {
    	this.networkInterface.addToUpLinkQueue(
                new Packet(this, destination, message));
    }
