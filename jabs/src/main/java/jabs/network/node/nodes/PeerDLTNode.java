...
public abstract class PeerDLTNode<B extends Block<B>, T extends Tx<T>> extends Node {
    ...
    protected final HashSet<Gossip> alreadySeenGossips = new HashSet<>();
    ...
    public void processIncomingPacket(Packet packet) {
        ...
        if (message instanceof DataMessage) {
            ...
            Gossip gossip = ((GossipMessage) message).getGossip();
            if (!alreadySeenGossips.contains(gossip)) {
                alreadySeenGossips.add(gossip);
                this.processNewGossip(gossip);
            }
        }
    ...
    protected abstract void processNewGossip(Gossip gossip);
