...
public abstract class Network<N extends Node, NodeType extends Enum<NodeType>> {
    ...
    public abstract void populateNetwork(Simulator simulator, ConsensusAlgorithmConfig consensusAlgorithmConfig); // for the PBFT protocol
    public abstract void populateNetwork(Simulator simulator, int numNodes, ConsensusAlgorithmConfig consensusAlgorithmConfig, int neighborCacheSize, double value_i, double weight_i, double value, double weight, double vDataAggregation, double wDataAggregation, double vConvergence, double vAgreement, double weightValue); // for the BECP protocol
    public abstract void populateNetwork(Simulator simulator, int numNodes, ConsensusAlgorithmConfig consensusAlgorithmConfig); // for the Snow protocol
